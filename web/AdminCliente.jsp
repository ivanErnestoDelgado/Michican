<%-- 
    ...
    Created on : 4/06/2024, 09:39:26 PM
    Author     : SADValenz
--%>
       ...
       function validarCorreo(){
        ...
        function redireccionar(){
            ...
            if(validarContrasena()&&validarCorreo()&&validarNombre()&&validarTelefono()&&validarApellido()){
                window.location.href="SVAdminRegCliente?correo="+correo+"&contrasena="+contrasena+"&telefono="+telefono+"&apellido="+apellido+"&nombre="+nombre+"&sexo="+sexo;
            }
                        ...
                        <div class="Contenedor-Registro">
                            ...
                            <form action="SVRegistro">
                                ...
                                <p class="contenedor-Input">
                                    ...
                                    <input class="boton" type="button" onclick="regresar();" value="Regresar"/>
                            </form>
                        </div>
                    </div>
                </td>
